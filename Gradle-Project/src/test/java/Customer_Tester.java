...
public class Customer_Tester
{
   ...
   {
     testRec.EmailAddress("stephencurranGmail.com");
   ...
   @Test(expected = IllegalArgumentException.class)
   public void Test_phone_contains_at_right_start()
   {
     testRec.EmailAddress("1234567890");
     assertEquals("123456789m", testRec.getPhoneNum());
   }
